...
export class ActivityComponentComponent implements OnInit {
  ...
  mainSliderUrl:any = 'http://bookingbash.com/server/api/bash/featured_content/?type=activity-plain';
  filterInput:any = [
    {
  ...
  url:any = "http://bookingbash.com/server/api/bash/featured_content/?type=activity-plain&count=3";
  filterUrl:any = "http://bookingbash.com/server/api/bash/filter_results/?activity=";
  genreUrl:any = 'http://bookingbash.com/server/api/bash/activities/?category=';
  head:any = 'Activities';
  icon:any = 'fa-calendar';
  activityUrl:any = 'http://bookingbash.com/server/api/bash/activities';
  activityContent:any;
  activity:any = [];
  modelId:any = 'activity';
  modalContent:any;
  modalGallery:any = [];
  modelClicked:any = false;
  modelTitle: any;
  modelImg: any;
  activityIds: any = [];
  prevId:any;
  nextId:any;
  isLoading=true;
  singleUrl:any = 'http://bookingbash.com/server/api/bash/activities/?slug=';
  error=false;
  mapContent;
  searchId;
  newModalContent;
  ...
  ngOnInit():any {
    this.appService.changeMenu('Activities');
    this.gettingSlug();
